    ...
    public class TexturePaintingWindow : Window, IDisposable
    {
        ...
        public override void Draw()
        {
            ...
            if (_floatingLayer != null)
            {
                ...
                if (ImGui.Button("Stamp Floating Layer"))
                {
                    ...
                    if (_floatingLayer.Is3DProjected)
                        _renderer.GpuStampTexture(_floatingLayer.SRV, _floatingLayer.Position, _floatingLayer.Scale, true, _floatingLayer.DecalCenter, _floatingLayer.DecalNormal, _floatingLayer.DecalTangent, _floatingLayer.DecalBitangent, _floatingLayer.Scale.X * 1.5f, 0.5f);
                    else
            ...
            if (_renderer != null && _gpuPaintInitialized && _needsComposite)
            {
                ...
                {
                    if (_floatingLayer.Is3DProjected)
                        _renderer.GpuPreviewStampTexture(_floatingLayer.SRV, _floatingLayer.Position, _floatingLayer.Scale, true, _floatingLayer.DecalCenter, _floatingLayer.DecalNormal, _floatingLayer.DecalTangent, _floatingLayer.DecalBitangent, _floatingLayer.Scale.X * 1.5f, 0.5f);
                    else
